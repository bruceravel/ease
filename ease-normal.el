;;; ease-normal.el --- minor mode for editing input files for normal
...
;; $Id: ease-normal.el,v 1.1.1.1 2000/05/21 05:46:16 bruce Exp $
...
(defcustom Normal-load-hook nil
  "*Hook run when ease-normal.el is first loaded."
  :group 'ease-programs
  :type 'hook)
	 ...
	 (if Normal-mode
	     (progn
	       ...
	       (setq imenu-generic-expression Normal-imenu-generic-expression
		     ...
		     ease-mouse-highlight-list Normal-highlight-list)
