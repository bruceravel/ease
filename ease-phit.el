;;; ease-phit.el --- minor mode for editing phit input files
...
;; $Id: ease-phit.el,v 1.1.1.1 2000/05/21 05:46:16 bruce Exp $
...
(require 'input)
(require 'ease-feffit)  ;; many feffit functions can be recycled for phit
...
(defcustom Phit-load-hook nil
  "*Hook run when ease-phit.el is first loaded."
  :group 'ease-programs
  :type 'hook)
...
(defun ease-Phit-choose-template ()
  (interactive)
	 ...
	 (if Phit-mode
	     (progn
	       ...
	       (setq imenu-generic-expression Phit-imenu-generic-expression
		     ...
		     ease-mouse-highlight-list Phit-highlight-list)
