;;; ease-generic.el --- minor mode for editing generic FEFF/FEFFIT input files
...
;; $Id: ease-generic.el,v 1.1.1.1 2000/05/21 05:46:16 bruce Exp $
...
(defcustom Generic-load-hook nil
  "*Hook run when ease-generic.el is first loaded."
  :group 'ease-programs
  :type 'hook)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	 ...
	 (if Generic-mode
	     (progn
	       ...
	       (setq imenu-generic-expression Generic-imenu-generic-expression
		     ...
		     ease-mouse-highlight-list Generic-highlight-list)
...
(provide 'ease-generic)
(run-hooks 'Generic-load-hook)

;;;============================================================================
;;;
;;; ease-generic.el end here
