...
;; $Id: ease-icons.el,v 1.1.1.1 2000/05/21 05:46:16 bruce Exp $
...
(defvar ease-toolbar-document-xpm
  (if (featurep 'xpm)
      (toolbar-make-button-list
       "/* XPM */
...
(defvar ease-toolbar-helper-xpm
  (if (featurep 'xpm)
      (toolbar-make-button-list
       "/* XPM */
...
(defvar ease-toolbar-new-file-xpm
  (if (featurep 'xpm)
      (toolbar-make-button-list
       "/* XPM */
...
(defvar ease-toolbar-program-document-xpm
  (if (featurep 'xpm)
      (toolbar-make-button-list
       "/* XPM */
...
(defvar ease-toolbar-return-to-ease-xpm
  (if (featurep 'xpm)
      (toolbar-make-button-list
       "/* XPM */
...
(defvar ease-toolbar-template-xpm
  (if (featurep 'xpm)
      (toolbar-make-button-list
       "/* XPM */
static char *comment3[] = {
...
(defvar ease-toolbar-tutorial-xpm
  (if (featurep 'xpm)
      (toolbar-make-button-list
       "/* XPM */
static char *book_index[] = {
