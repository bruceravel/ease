;;; ease-diffkk.el --- minor mode for editing diffkk input files with EASE
...
;; $Id: ease-diffkk.el,v 1.1.1.1 2000/05/21 05:46:16 bruce Exp $
...
(defcustom Diffkk-load-hook nil
  "*Hook run when ease-diffkk.el is first loaded."
  :group 'ease-programs
  :type 'hook)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(when (and ease-xemacs-p (featurep 'toolbar))
  (require 'ease-toolbar)
  (defvar Diffkk-toolbar
    '([ease-toolbar-template-xpm Diffkk-toolbar-template
				 t "Write a Diffkk template"]
      [ease-toolbar-run-xpm    Diffkk-toolbar-run
			       t "Run Diffkk"]
      [ease-toolbar-log-xpm    Diffkk-toolbar-log
  ...
  (add-hook 'Diffkk-mode-hook
	    '(lambda ()
	       (and (featurep 'toolbar)
		    (message "EASE: setting up Diffkk toolbar")
		    (ease-make-toolbar-function Diffkk-toolbar))))
  ...
  (fset 'Diffkk-toolbar-quit     'ease-quit)  )
;;----------------------------------------------------------------------
...
(if Diffkk-mode-map
  ...
  (define-key Diffkk-mode-map "\C-c\C-sn"  'input-insert-z-number)
  )
...
(easy-menu-define
 ...
 '("Diffkk"
   ...
   ["Insert Z number"                   input-insert-z-number t]
	 ...
	 (if Diffkk-mode
	     (progn
	       ...
	       (setq imenu-generic-expression Diffkk-imenu-generic-expression
		     ...
		     ease-mouse-highlight-list Diffkk-highlight-list)
